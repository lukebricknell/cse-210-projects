public class AdsMain
{
  ...
  public void CreateAd() {
        ...
        {
          Console.Write("What is the engagement ranking on your ad? ");
          string engagementRanking = Console.ReadLine();

          Engagement engagement = new Engagement(name, "Engagement", reach, impressions, costPerResult, startingDate, engagementRanking);
          _ads.Add(engagement);
        }
        else if (adChoice == 6)
        {
  ...
  public void UpdateAd() 
  {
    ...
    Console.WriteLine("Write the number of the ad you'd like to update.");
  ...
  public void Update(int choice)
  {
    ...
    {
      Console.WriteLine("How many link clicks does your ad have now?");
      int linkClicks = int.Parse(Console.ReadLine());
    ...
    {
      Console.WriteLine("How many leads does your ad have now?");
    ...
    {
      Console.WriteLine("How many sales does your ad have now?");
    ...
    {
      Console.WriteLine("What is the engagement ranking on your ad now?");
      string engagementRanking = Console.ReadLine();
    ...
    {
      Console.WriteLine("How many downloads does your ad have now?");
      int downloads = int.Parse(Console.ReadLine());
      Console.WriteLine("How many link clicks does your ad have now?");
      int linkClicks = int.Parse(Console.ReadLine());
